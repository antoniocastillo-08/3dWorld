<nav x-data="{ open: false }" class="bg-gradient-to-b from-teal-300 to-white border-b border-gray-100 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('favicon.ico') }}" alt="Logo" class="block h-15 w-auto">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link href="{{ route('printers.index') }}">
                            {{ __('Printers') }}
                        </x-dropdown-link>
